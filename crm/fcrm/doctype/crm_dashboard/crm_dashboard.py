...
CURATED_TILE_METRICS = (
	...
	"plan_adherence",
	"quota_attainment",
	# Promoted to the tile row so reps see it too: the count sits directly above
	# the "Needs your attention" panel that explains it, for every role. It was a
	# manager-grid card before, which hid the one at-a-glance risk number from
	# the people who own the deals.
	"deals_at_risk",
)
