...
category: Valves
tags: control valve, globe control valve, modulating, throttling, Cv, Kv, flow coefficient, positioner, trim, cage guided, anti-cavitation, noise, rangeability, characteristic, equal percentage, linear, quick opening, V-port ball, segmented ball, rotary control valve, IEC 60534, ISA 75
---
...
- DN 15 to DN 400 for globe bodies; rotary valves larger.
- Class 150 to Class 2500; Class 300 is the common refinery specification.
- Rangeability of 30:1 to 50:1 for globe trims; higher for segmented ball.
- Seat leakage by ANSI/FCI 70-2 class — Class IV standard metal seat, Class VI soft seat.

## Materials

Bodies in WCB, WC9, CF8M, duplex and alloys. Trim in 316 stainless, 17-4 PH, Stellite hard-facing, tungsten carbide for erosive service. Packing in PTFE V-ring or graphite; live-loaded for fugitive-emissions compliance. Diaphragms in NBR or EPDM.
...
Strengths: precise, repeatable regulation; diagnostics from a smart positioner; one valve replaces a bypass-and-throttle arrangement. Limits: expensive; oversizing is the commonest failure (the valve hunts near the seat); cavitation, flashing and noise must be checked at every case; and it is not an isolation valve — block valves either side and a bypass if the loop cannot go down.
...
IEC 60534 / ISA 75 series (sizing, testing, noise, face-to-face), ANSI/FCI 70-2 (seat leakage classes), ASME B16.34 (pressure-temperature ratings), ASME B16.5 and SANS 1123 (flanges), IEC 61508 / 61511 where part of a safety instrumented function, ATEX / IECEx for positioners in hazardous areas.
