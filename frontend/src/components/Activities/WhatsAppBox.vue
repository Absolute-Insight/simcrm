...
<template>
  ...
  >
    <div
      class="mb-1 ml-13 flex-1 cursor-pointer rounded-[var(--v-radius-control)] border-0 border-l-4 border-green-500 bg-surface-gray-2 p-2 text-base text-ink-gray-5"
