...
import { PhShareNetwork as LucideShare2 } from '@phosphor-icons/vue'
import { PhEye as LucideEye } from '@phosphor-icons/vue'
import { PhEyeSlash as LucideEyeOff } from '@phosphor-icons/vue'
import { PhPencilSimple as LucidePencil } from '@phosphor-icons/vue'
import { PhArrowSquareOut as LucideExternalLink } from '@phosphor-icons/vue'
import { PhCheck as LucideCheck } from '@phosphor-icons/vue'
import { PhListDashes as LucideLayoutList } from '@phosphor-icons/vue'
import { PhGear as LucideSettings } from '@phosphor-icons/vue'
...
const tabIndex = ref('editor')
const tabs = [
  {
    value: 'editor',
    name: 'editor',
    label: __('Editor'),
    iconLeft: LucideLayoutList,
  },
  {
    value: 'settings',
    name: 'settings',
    label: __('Settings'),
    iconLeft: LucideSettings,
  },
